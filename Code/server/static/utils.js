...
export function print_connectionMessage(ip_address, port) {
  ...
  const IPlines = ["┌──────────────────────────────────────────────────────────────────────────────┐", "│                                                                              │", "│ VS-Code: " + clc.green("'ctrl + click'") + " on the IP below to open the website in your browser. │", "│                                                                              │", "│ Otherweise you can " + clc.green("copy") + " the IP to open the website in your browser.          │", "│                                                                              │", "│ My socket server is running on:       " + stringIPAdress + leerraumIP + "│", "│                                                                              │", "│ If you can't access with IP, try:     " + stringLocalhost + leerraumLH + "│", "│                                                                              │", "└──────────────────────────────────────────────────────────────────────────────┘"];
...
export function print_clientConnected(socket_id) {
  const clientConnected = ["┌──────────────────────────────────────┐", "│ New client connected!                │", "│ Socket-id:   " + socket_id + "    │", "└──────────────────────────────────────┘"];
...
export function print_clientDisconnected(socket_id) {
  const clientDisconnected = ["┌──────────────────────────────────────┐", "│ Client disconnected!                 │", "│ Socket-id:   " + socket_id + "    │", "└──────────────────────────────────────┘"];
